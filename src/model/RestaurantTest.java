...
//	}
	...
	public void testStringToJSONArray(){
		String jsonString = "Chinese,Japanese,Italian";
		JSONArray new_jsonArray = Restaurant.stringToJSONArray(jsonString);
		assertEquals("[\"Chinese\",\"Japanese\",\"Italian\"]", new_jsonArray.toString());
	}
	
	@Test
	public void testStringToJSONArrayNullCase() {
		String jsonString = "";
		JSONArray jsonArray = new JSONArray();
		JSONArray new_jsonArray = Restaurant.stringToJSONArray(jsonString);
		assertEquals(jsonArray.toString(), new_jsonArray.toString());
	}
	...
	public void testStringToJSONArrayMissingValue() {
		...
		JSONArray new_jsonArray = Restaurant.stringToJSONArray(jsonString);
		assertEquals("[\"Chinese\",\"Japanese\"]", new_jsonArray.toString());
		jsonString = "Chinese,,Japanese";
		new_jsonArray = Restaurant.stringToJSONArray(jsonString);
		assertEquals("[\"Chinese\",null,\"Japanese\"]", new_jsonArray.toString());
	}
}